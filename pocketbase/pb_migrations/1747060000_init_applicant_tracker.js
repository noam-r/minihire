migrate((app) => {
  const jobs = new Collection({
    ...
    fields: [
      ...
      },
      {
        ...
        min: 1,
        max: 1000,
        help: "Short summary shown on the public jobs list.",
      },
      {
        name: "description",
        type: "text",
        required: true,
        help: "Full job description in raw Markdown.",
      },
      {
        name: "whatToExpect",
        type: "text",
      ...
      },
      {
        ...
        help: "How the role is structured for work location.",
      },
      {
        name: "workLocation",
        type: "text",
        required: false,
        max: 120,
        help: "Optional location detail such as city, country, or timezone overlap.",
      },
      {
        name: "employmentType",
        type: "select",
        ...
        help: "Type of employment for the role.",
      },
      {
        name: "status",
        type: "select",
      ...
      },
      {
        ...
        type: "text",
        required: false,
        help: "Required skills, one per line.",
      },
      {
        name: "niceToHaveSkills",
        type: "text",
        required: false,
        help: "Optional or bonus skills, one per line.",
      },
      {
        name: "hiringProcess",
        type: "text",
        required: false,
        help: "Optional hiring-process content in raw Markdown.",
      },
      {
        name: "publishedAt",
        type: "date",
        required: false,
        help: "Set the first time the role is published.",
      },
    ],
    indexes: [
  ...
  const applications = new Collection({
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        maxSelect: 1,
        values: ["new", "reviewing", "maybe", "rejected", "interview", "offer", "hired", "withdrawn"],
      },
      {
        name: "duplicate_key",
        type: "text",
  ...
  for (const name of collectionNames) {
    try {
      ...
      // Ignore missing collections during down migrations.
    }
  }
});
